...
func (s *Server) setupRouter() {
	...
	sr.HandleFunc("/users", api.UsersOptionsHandler).Methods("OPTIONS")
	sr.HandleFunc("/users", api.UserListHandler).Methods("GET")
	sr.HandleFunc("/users/{id}", api.UsersOptionsHandler).Methods("OPTIONS")
	sr.HandleFunc("/users/{id}", api.UserDeleteHandler).Methods("DELETE")
